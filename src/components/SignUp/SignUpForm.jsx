...
const SignUpFormModal = ({ openSignupModal, handleCloseSignupModal, handleShowLoginModal }) => {
        ...
        <Dialog open={openSignupModal} onClose={handleCloseSignupModal}>
            <form className={classes.root} onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <Button type="submit" variant="contained" color="primary" onClick={handleCloseSignupModal}>
                        Cancel
                    </Button>
